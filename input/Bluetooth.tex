...
\begin{figure}[htbp!!!!]
	\begin{center}
		...
		\caption[PacketPayload Header]{PacketPayload Header \cite{9_Teildokument_BT}} %picture caption
...
\begin{figure}[htbp!!!!]
	\begin{center}
		...
		\caption[PacketPayload Payload]{PacketPayload Payload \cite{9_Teildokument_BT}} %picture caption
